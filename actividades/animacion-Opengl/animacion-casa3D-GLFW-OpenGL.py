import glfw
from OpenGL.GL import GL_TRIANGLES, glBegin, glColor3f, glVertex3f, glEnd, glRotatef, glLoadIdentity, glClear, GL_COLOR_BUFFER_BIT, GL_DEPTH_BUFFER_BIT, glFlush, GL_QUADS, glEnable, GL_DEPTH_TEST, glClearColor
...
def display():
    ...
    gluLookAt(4, 3, 8,
              0, 1, 0,
              0, 1, 0)  # Mira la casa desde un poco más lejos
