...
movement_speed = 0.0005  # Velocidad del movimiento
movement_direction_x = random.choice([-1, 2])  # Dirección de movimiento en X (inicialmente aleatoria)
movement_direction_y = random.choice([-1, 2])  # Dirección de movimiento en Y (inicialmente aleatoria)
...
def init():
    ...
    material_diffuse = [0.2, 0.2, 1.0, 1.0]  # Color difuso (azul claro)
