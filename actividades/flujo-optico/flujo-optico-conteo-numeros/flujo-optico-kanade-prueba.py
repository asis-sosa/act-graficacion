...
while True:
    ...
    if p1 is None:
        ...
        for i, (nv, vj) in enumerate(zip(bpl, bp0)):
        ...
        if i == 0 and dist > 50:
            cad = cad + '0'
        elif i == 1 and dist > 50:
            cad = cad + '1'
        elif i == 2 and dist > 50:
            print('2', dist)
            cad = cad + '2'
        elif i == 3 and dist > 50:
            cad = cad + '3'

        frame = cv.putText(frame, cad, (50,50), cv.FONT_HERSHEY_SIMPLEX, 1,(255,0,0),2, cv.LINE_AA)
        frame = cv.putText(frame, str(1), (c,d), cv.FONT_HERSHEY_SIMPLEX, 1, (255,0,0),2, cv.LINE_AA)
