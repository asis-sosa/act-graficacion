...
def load_texture(filename):
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, bytes(image_data))
...
def main():
    ...
    trunk_texture = load_texture(r"D:\Sexto Semestre\Graficacion\texturas-objeto\trunk.jpg")      # Textura para el tronco
    foliage_texture = load_texture(r"D:\Sexto Semestre\Graficacion\texturas-objeto\foliage.jpg") # Textura para las hojas
    ground_texture = load_texture(r"D:\Sexto Semestre\Graficacion\texturas-objeto\ground.jpg")   # Textura para el suelo
